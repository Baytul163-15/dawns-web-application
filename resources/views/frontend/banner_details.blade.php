			...
			<div class="row">
				...
				<div id="grid-list-view">
					<ul class="products-list">
						...
						@php
						// $types = App\Models\Product::where('hot_new',1)->first();
							...
							<div class="product product-sm">
								...
								<div class="product-details-area">
									...
									<div class="product-short-desc">
										{{-- @if($prow->generic_id != null)
										<p clase="product-short-desc-sub">Generic : {{$prow->generic->generic_name}}</p>
										@endif --}}
										@if($prow->brand_id != null)
									...
									<div class="product-price-box">
										...
										@if ($prow->discount_price == 0)
                                    <div class="product-price"><span class="price">{{$prow->selling_price}}৳</span></div>
                                    @else
                                    <div class="product-price"><span class="price">{{$prow->discount_price}}৳</span> <br><span class="price-before-discount" style="text-decoration: line-through;">{{$prow->selling_price}}৳</span></div>
                                    @endif
