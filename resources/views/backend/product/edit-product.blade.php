                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" name="selling_price" value="{{$product->selling_price}}" id="selling_price" class="form-control" placeholder="Enter selling price">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="unit" id="unit" class="form-control"value="{{ $product->unit }}">
                                            ...
                                            <div style='color:red; padding: 0 5px;'>{{($errors->has('unit'))?($errors->first('unit')):''}}</div>
                                        </div>
                                    </div> <!/--dsfjdsjf-->
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="c2">Feature Product</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-check">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="c6">New Arrivals</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
